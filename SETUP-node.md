...
PC users take note: if you are using WSL , then at that point you will need to install node again on your Ubuntu side.
...
Playwright is the browser automation software from Microsoft 
