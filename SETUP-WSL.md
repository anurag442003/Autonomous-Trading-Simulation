...
MCP Servers are only working on Windows under WSL.

I'm so sorry to put you through this! WSL is generally considered a great way to build on Windows. And the other good news is that you've already done the setup once, so surely this will be relatively painless? Fingers crossed.
